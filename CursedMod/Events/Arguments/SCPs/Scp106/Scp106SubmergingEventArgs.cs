// -----------------------------------------------------------------------
// <copyright file="Scp106SubmergingEventArgs.cs" company="CursedMod">
...
public class Scp106SubmergingEventArgs : EventArgs, ICursedCancellableEvent, ICursedPlayerEvent
{
    public Scp106SubmergingEventArgs(Scp106HuntersAtlasAbility huntersAtlasAbility)
    {
        IsAllowed = true;
