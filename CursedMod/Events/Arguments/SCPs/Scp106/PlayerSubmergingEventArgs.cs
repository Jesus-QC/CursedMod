// -----------------------------------------------------------------------
// <copyright file="PlayerSubmergingEventArgs.cs" company="CursedMod">
...
public class PlayerSubmergingEventArgs : EventArgs, ICursedCancellableEvent, ICursedPlayerEvent
{
    public PlayerSubmergingEventArgs(Scp106HuntersAtlasAbility huntersAtlasAbility)
    {
        IsAllowed = true;
